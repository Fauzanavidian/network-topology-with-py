...
class MyTopo ( Topo ):
	def __init__(self, **opts):
		...
		self.addLink( h2 , r3, intfName1='h2-eth0', intfName2='r3-eth0' ,cls=TCLink , bw=1 )
		self.addLink( h2 , r4, intfName1='h2-eth1', intfName2='r4-eth1' ,cls=TCLink , bw=1 )

		self.addLink( r1 , r4, intfName1='r1-eth2', intfName2='r4-eth2', cls=TCLink , bw=1 )
		self.addLink( r2 , r3, intfName1='r2-eth2', intfName2='r3-eth2', cls=TCLink , bw=1 )
		self.addLink( r1 , r3, intfName1='r1-eth1', intfName2='r3-eth1', cls=TCLink , bw=0.5 )
		self.addLink( r2 , r4, intfName1='r2-eth0', intfName2='r4-eth0', cls=TCLink , bw=0.5 )
...
def runTopo():
	...
	h1.cmd("ifconfig h1-eth1 192.168.6.2 netmask 255.255.255.0")

	h2.cmd("ifconfig h2-eth0 0")	
	h2.cmd("ifconfig h2-eth0 0")	
	h2.cmd("ifconfig h2-eth0 192.168.3.2 netmask 255.255.255.0")
	...
	r2.cmd("ifconfig r2-eth0 192.168.5.2 netmask 255.255.255.0")
	...
	r3.cmd("ifconfig r3-eth2 192.168.8.1 netmask 255.255.255.0")


	r4.cmd("ifconfig r4-eth0 0")
	r4.cmd("ifconfig r4-eth1 0")
	r4.cmd("ifconfig r4-eth2 0")
	r4.cmd("ifconfig r4-eth0 192.168.5.1 netmask 255.255.255.0")
	r4.cmd("ifconfig r4-eth1 192.168.4.2 netmask 255.255.255.0")
	r4.cmd("ifconfig r4-eth2 192.168.7.2 netmask 255.255.255.0")
	...
	h1.cmd("ip rule add from 192.168.6.2 table 2")
	...
	h1.cmd("ip route add 192.168.6.0/24 dev h1-eth1 scope link table 2")
	h1.cmd("ip route add default via 192.168.6.1 dev h1-eth1 table 2")
	h1.cmd("ip route add default scope global nexthop via 192.168.1.2 dev h1-eth0")

	#route h2
	h2.cmd("ip rule add from 192.168.3.2 table 3")
	h2.cmd("ip rule add from 192.168.4.1 table 4")
	h2.cmd("ip route add 192.168.3.0/24 dev h2-eth0 scope link table 3")
	h2.cmd("ip route add default via 192.168.3.1 dev h2-eth0 table 3")
	h2.cmd("ip route add 192.168.4.0/24 dev h2-eth1 scope link table 4")
	h2.cmd("ip route add default via 192.168.4.2 dev h2-eth1 table 4")
	...
	r1.cmd("route add -net 192.168.8.0/24 gw 192.168.2.2")
	
	r2.cmd("route add -net 192.168.3.0/24 gw 192.168.8.1")
	r2.cmd("route add -net 192.168.2.0/24 gw 192.168.8.1")
	r2.cmd("route add -net 192.168.7.0/24 gw 192.168.5.1")
	r2.cmd("route add -net 192.168.1.0/24 gw 192.168.8.1")
	r2.cmd("route add -net 192.168.4.0/24 gw 192.168.5.1")
	
	r3.cmd("route add -net 192.168.5.0/24 gw 192.168.8.2")
	r3.cmd("route add -net 192.168.6.0/24 gw 192.168.8.2")
	r3.cmd("route add -net 192.168.7.0/24 gw 192.168.2.1")
	r3.cmd("route add -net 192.168.1.0/24 gw 192.168.2.1")
	r3.cmd("route add -net 192.168.4.0/24 gw 192.168.8.2")
	
	r4.cmd("route add -net 192.168.1.0/24 gw 192.168.7.1")
	r4.cmd("route add -net 192.168.2.0/24 gw 192.168.7.1")
	r4.cmd("route add -net 192.168.8.0/24 gw 192.168.5.2")
	r4.cmd("route add -net 192.168.3.0/24 gw 192.168.7.1")
	r4.cmd("route add -net 192.168.6.0/24 gw 192.168.5.2")
